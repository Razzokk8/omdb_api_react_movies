export const Footer = () => {
    ...
    <div className="text-center">Coded with ❤️ by:
        ...
        <span className="d-flex justify-content-center"><div className="miniC me-3 scale-up-center">
                ...
                <div className="miniC ms-3">
                    <a href='https://www.instagram.com/there1zz/?hl=en' target='_blank' className="slide-top">
